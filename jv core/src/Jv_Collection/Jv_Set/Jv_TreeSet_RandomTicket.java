...
public class Jv_TreeSet_RandomTicket {
    Set<String> randomTicket = new TreeSet<>();
    public Jv_TreeSet_RandomTicket() {
    }
    ...
    public static void main(String[] args) {
        ...
        Jv_TreeSet_RandomTicket rt = new Jv_TreeSet_RandomTicket();
        int choiceUser = 0;
        do {
